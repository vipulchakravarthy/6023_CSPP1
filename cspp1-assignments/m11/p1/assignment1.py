...
accept as input a string of lowercase letters (a word) and return the
...
def main():
    '''
    Main function for the given problem. if the word is given as input 
    the program is to calculate the score of given word.
    '''
    data = input()
    data = data.split()
